...
#include "../../CustomWidget/ledindicator.h"
...
QT_MOC_LITERAL(4, 35, 11), // "setTurnedOn"
QT_MOC_LITERAL(5, 47, 4), // "text"
QT_MOC_LITERAL(6, 52, 8) // "turnedOn"

    },
    "LedIndicator\0stateToggled\0\0setText\0"
    "setTurnedOn\0text\0turnedOn"
};
...
void LedIndicator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->setTurnedOn((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (LedIndicator::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&LedIndicator::stateToggled)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject LedIndicator::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_LedIndicator.data,
      qt_meta_data_LedIndicator,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
